var protocol='s' in qp?"https://":"http://";
var c=g_conf_info;
resp_off();
...
safe_promise_all(
  mapkeys(c.vh2host).map(e=>axhr_post(protocol+c.vh2host[e]+path,{unixtime:unixtime(),code:code},{vhost:e,host:c.vh2host[e],bef_ms:get_ms()}).then(e=>mapaddfront(e,{ms:get_ms()-e.ud.bef_ms})))
