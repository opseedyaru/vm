...
var g_conf_info=((()=>{
  ...
  out.wm_ids_src={"os3":"1,2","vm10":"34,33","vm20":"37,38","vm30":"1,2,33,34,37,38"};
  var all=(beg,end)=>{var arr=[];for(var i=beg;i<=end;i++)arr.push(i);return arr.join(",");};
  out.wm_ids_src.ae=all(1,160);
